...

{
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            /*THE FOLLOWING SETS UP PID STUFF FOR THE RIGHT AND LEFT MOTORS*/
            ...
            while (true)
            {
                ...
                /* BUILD IMU AND ENCODER DATA INTO STRINGS */
                ...
                /* COMPILE IMU AND ENCODER STRINGS INTO ONE LONG STRING AND BYTEARRAY */
                ...
                if (_uart.BytesToRead > 0)
                {
                    ...
                    for (int i = 0; i < readCnt; ++i)
                    {
                        ...
                        if (_rx[i] == 44 && start == true)
                        {
                            numcount++;
                        }
                        if (count > 30 && start == true)
                        {
                            start = false;
                            /* RESET INPUT */
                            input = "";
                ...
                //PRINT THE COMMANDS WE GOT
                Debug.Print("RECIEVED X: " + cmd_vel[0] + "\nRECIEVED Z: " + cmd_vel[1]);
