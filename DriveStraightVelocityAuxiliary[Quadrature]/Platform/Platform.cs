...
namespace DriveStraightVelocityAuxiliary.Platform
{
    public static class Constants
    {
	     ...
	     */
        public const int kEncoderUnitsPerRotation = 7782;
        ...
        public static Framework.Gains kGains_Turning = new Framework.Gains(2.0f, 0.0f, 10.0f, 0.0f,              200f, 1.00f);
        public static Framework.Gains kGains_Velocit = new Framework.Gains(0.1f, 0.0f, 20.0f, 1023.0f / 6450.0f, 300f, 1.00f); /* measured 6800 velocity units at full motor output */
        public static Framework.Gains kGains_MotProf = new Framework.Gains(1.0f, 0.0f,  0.0f, 1023.0f / 6450.0f, 400f, 1.00f); /* measured 6800 velocity units at    */
    ...
    public static class Hardware
    {
        ...
        public static TalonSRX _rightTalon = new TalonSRX(2);
        public static TalonSRX _leftTalon = new TalonSRX(1);
        //public static VictorSPX _leftVictor = new VictorSPX(2);
        public static PigeonIMU _pidgey = new PigeonIMU(0);
