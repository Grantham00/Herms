...
namespace HERO_Serial_Example
{
    public class Program
    {
        ...
        public static void Main()
        {
             ...
             *   
             */
            _uart = new System.IO.Ports.SerialPort(CTRE.HERO.IO.Port4.UART, 115200, System.IO.Ports.Parity.None, 8, System.IO.Ports.StopBits.One);
            _uart.Open();
            ...
            while (true)
            {
				...
				if (_uart.BytesToRead > 0)
                {
                    ...
                    {
                        PushByte(_rx[i]);
						Debug.Print("RECEIVED: " + (char)_rx[i]);
                    }
                }
